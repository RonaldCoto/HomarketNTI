...
func NewHttpGetInventoryResponseHandler(path string, endpoints endpoint.Endpoint) http.Handler {
	r := mux.NewRouter()
	r.Handle(path,
...
func DecodeRequest(ctx context.Context, r *http.Request) (interface{}, error) {
	var inventoryRequest GetInventoryRequest
...
func EncodeResponse(ctx context.Context, w http.ResponseWriter, response interface{}) error {
	...
	resp, _ := response.(getInventoryInternalResponse)
	if resp.Err != nil {
